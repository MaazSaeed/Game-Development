...
gSounds = {
    ...
    ['newlevel'] = love.audio.newSource('sounds/newlevel.wav', 'static'),
    ['explode-lock'] = love.audio.newSource('sounds/explode-lock.wav', 'static')
...
gFrames = {
    ...
    ['flags-posts'] = GenerateFlagPosts(gTextures['flags-posts'], 16, 48),
    ['flags'] = GenerateFlags(gTextures['flags-posts'], 16, 16)
}
