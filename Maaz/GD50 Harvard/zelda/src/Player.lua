...
function Player:update(dt)
    ...
    if self.holdingPot and not self.isTweening then
...
function Player:render()
    ...
    if self.holdingPot and not self.tweeningFinished then
    ...
    elseif self.holdingPot and self.tweeningFinished then
        love.graphics.draw(gTextures[self.holdingPot.texture], 
        gFrames[self.holdingPot.texture][self.holdingPot.frame], 
